...
class MrpCostStructure(models.AbstractModel):
    _name = 'report.mrp_account_custom.mrp_cost_structure'
...
class ProductTemplateCostStructure(models.AbstractModel):
    _name = 'report.mrp_account_custom.product_template_cost_structure'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        res = self.env['report.mrp_account_custom.mrp_cost_structure'].get_lines(productions)
        return {'lines': res}
